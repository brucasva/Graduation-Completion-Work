...
#%% Import Data
# DATA=pd.read_hdf(path + 'SOLETE_short.h5')
# DATA=pd.read_hdf(path + 'SOLETE_Pombo_5min.h5')
DATA=pd.read_hdf('C:/Users/Bruno/Documents/TCCv2/Data/Solete/SOLETE_Pombo_5min.h5')
